...
import { FieldErrorComponent } from '@fe/signalformutilities/field-error';
...
@Component({
  selector: 'lib-signalformprofil',
  imports: [
    Control,
    JsonPipe,
    FieldErrorComponent
  ],
  templateUrl: './signalformprofil.component.html',
  styleUrl: './signalformprofil.component.scss',
})
export class SignalformprofilComponent {
